...
class BachLecturerActionPage extends ContentPage
{
	private $mode;
	private $nextpage;
	private $content;
	...
	private function processAction()
	{
		if ( ServerUtils::checkRequestData( 'start_approve', ServerUtils::DATA_SOURCE_POST ) )
		{
			...
			$this->nextpage	= 'bach_action'; // action should return to complete 
		...
		{	// title accepted
			...
			// add new log record
			$newTitle->bachelorApproved = true;
			...
			{	// swap records
				...
				return 'Tēma tika apstiprināta. Tēmas vadītājs un piesaistītie studenti saņems e-pasta notifikāciju.';
			}
		}
		...
		{	// title refused
			...
			{	// swap records
				...
				return 'Tēma tika atteikta. Tēmas vadītājs un piesaistais students saņems e-pasta notifikāciju.';
			}
		}
	...
	public function execute()
	{
		...
		$this->mode 	= '';
		$this->nextpage = 'bach';
		$this->content 	= 'content_bach_lecturer_action';
